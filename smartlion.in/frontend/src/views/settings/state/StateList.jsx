...
import { changeStatusApi, StateListApi } from 'apis/Location';
...
let recordsTotal = 0;
const StateList = ({ search, countryID, setCountryData }) => {
    ...
    useEffect(() => {
        ...
        params.country_id = countryID ?? params.country_id;
        ...
        getData();
    }, [page, rowsPerPage, order, orderBy, search, countryID]);
    ...
    return (
        <TableHead>
            <TableRow>
                ...
                <TableCell key="country" sx={{ width: '40%' }}>
