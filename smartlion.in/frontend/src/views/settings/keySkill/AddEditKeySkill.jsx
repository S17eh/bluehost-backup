...
import { addUpdateKeySkillApi } from 'apis/Setting';
...
const AddEditKeySkill = ({ value, formID, onSubmit }) => {
...
AddEditKeySkill.propTypes = {
    value: propTypes.object,
    formID: propTypes.string,
    onSubmit: propTypes.func
};

export default AddEditKeySkill;
