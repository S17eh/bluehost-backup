...
import KeySkillList from './KeySkillList';
        ...
        <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={12} md={4}>
                <Card variant="outlined">
                    <CardHeader title="Add Key Skill" />
                    <CardContent>
                        {checkRestriction('CAN_ADD_KEY_SKILL') ? (
                            <AddEditKeySkill formID="addKeySkill" onSubmit={submitHandler} />
                        ) : (
                            <Typography
                                sx={{
                                    p: '8%'
            ...
            <Grid item xs={12} sm={12} md={8}>
                <MainCard
                            ...
                            <Grid item xs={12}>
                                <Grid container spacing={gridSpacing}>
                                    <Grid item sx={{ flexGrow: 1 }}>
                                        <Typography variant="column">Key Skill List</Typography>
                                    </Grid>
                                    <Grid item>
                                        <OutlinedInput
                    ...
                    content={true}
                >
                    <KeySkillList search={search} callApi={callApi} />
                </MainCard>
            </Grid>
        </Grid>
    );
