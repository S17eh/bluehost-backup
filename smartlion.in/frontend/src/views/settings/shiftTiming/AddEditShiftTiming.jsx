...
import { addUpdateShiftTimingApi } from 'apis/Setting';
...
const AddEditShiftTiming = ({ value, formID, onSubmit }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            addUpdateShiftTimingApi(values)
                .then((res) => {
...
AddEditShiftTiming.propTypes = {
    value: propTypes.object,
    formID: propTypes.string,
    onSubmit: propTypes.func
};

export default AddEditShiftTiming;
