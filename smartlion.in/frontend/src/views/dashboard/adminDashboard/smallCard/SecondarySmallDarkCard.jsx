...
const SecondarySmallDarkCard = ({ isLoading, title, count, amount }) => {
                    ...
                    <Box sx={{ p: 2 }}>
                        <List sx={{ py: 0 }}>
                            <ListItem alignItems="center" disableGutters sx={{ py: 0 }}>
                                <ListItemAvatar onClick={() => handleFilter('filterStatus', status)}>
                                    <Avatar
                                        variant="rounded"
                                        sx={{
                                ...
                                <ListItemText
                                    ...
                                    secondary={
                                        <Typography
                                            variant={amount ? 'subtitle2' : 'h4'}
                                            sx={!amount ? { color: '#fff' } : { color: 'primary.light', mt: 0.25 }}
                                        >
                                            {title}
                                        </Typography>
                                    }
...
SecondarySmallDarkCard.propTypes = {
...
export default SecondarySmallDarkCard;
