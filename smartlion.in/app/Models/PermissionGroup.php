...
class PermissionGroup extends Model
{
    ...
    protected $allowedFields    = ['name', 'description', 'permissions', 'restrictions', 'created_at', 'updated_at'];
    ...
    public function getPermissionGroup($filters = array(), $returnAssoc = false, $returnSingleRow = false)
    {
