...
class Restriction extends Model
{
    ...
    public function getRestriction($filters = array(), $returnAssoc = false, $returnSingleRow = false)
    {
        ...
        if (isset($filters['permission']) && $filters['permission'] != '0') $builder->where('r.permission_id', $filters['permission']);
