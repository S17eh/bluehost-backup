            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title mt-1">Contact Us</h3>
                        <div class="card-tools">
                            <a href="{{ route('contact-us-edit')}}" class="btn btn-primary btn-sm"><i class="fas fa-pen"> </i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2"><label>{{$key}} :</label></div>
