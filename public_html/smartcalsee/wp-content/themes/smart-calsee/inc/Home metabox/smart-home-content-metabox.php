...
function smart_contact_render_box( $post ) {
    ...
    <div class="country-selector-wrapper">
        <label for="smart_contact_country_select">Select Country:</label>
        <select id="smart_contact_country_select" name="smart_contact_country_select" class="smart-country-selector">
    ...
    ?>
    <div class="country-content smart-contact-content <?php echo $code === $selected_country ? 'active' : ''; ?>" data-country="<?php echo esc_attr( $code ); ?>">
    ...
    jQuery(document).ready(function($) {
        $('.smart-country-selector').on('change', function() {
            ...
            $('.smart-contact-content').removeClass('active').hide();
            $('.smart-contact-content[data-country="' + country + '"]').addClass('active').show();
        });
        
        var initialCountry = $('.smart-country-selector').val();
        $('.smart-contact-content').removeClass('active').hide();
        $('.smart-contact-content[data-country="' + initialCountry + '"]').addClass('active').show();
    });
    </script>
    <?php
}
