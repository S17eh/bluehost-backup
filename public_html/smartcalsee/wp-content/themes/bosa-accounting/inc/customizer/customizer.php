 ...
 */
add_action( 'customize_preview_init', 'bosa_accounting_customize_preview_js', 999, 1 );

function bosa_accounting_customize_preview_js() {
	wp_enqueue_script( 'bosa-accounting-customizer', get_stylesheet_directory_uri() . '/inc/customizer/customizer.js', array( 'customize-preview' ) );
}

function bosa_accounting_customize_getting_js() {
	wp_dequeue_script( 'bosa-customizer-getting-started' );
	wp_enqueue_script( 'bosa-accounting-customizer-getting-started', get_stylesheet_directory_uri() . '/inc/getting-started/getting-started.js', array( 'customize-controls', 'jquery' ), true );

	wp_enqueue_style( 'bosa-accounting-customize-controls', get_stylesheet_directory_uri() . '/inc/customizer/customizer.css' );
}
add_action( 'customize_controls_enqueue_scripts', 'bosa_accounting_customize_getting_js', 99 );
 ...
 * @return void
 */
add_action( 'init' , 'bosa_accounting_kirki_fields', 999, 1 );

function bosa_accounting_kirki_fields(){
	...
	*/
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Title', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Description', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu Description', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Body', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'General Title (H1 - H6)', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page & Single Post Title', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Title Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Meta Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Excerpt Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Slider Button Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Content Alignment', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'main_slider_content_alignment',
		'section'     => 'main_slider_options',
		'default'     => 'left',
		'choices'  => array(
			'center' => esc_html__( 'Center', 'bosa-accounting' ),
			'left'   => esc_html__( 'Left', 'bosa-accounting' ),
			'right'  => esc_html__( 'Right', 'bosa-accounting' ),
		),
		'priority'	  =>  180,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Title Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Description Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Excerpt Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Widget Title Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Layouts', 'bosa-accounting' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-accounting' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Top Header Section', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Non Transparent Mid Header Background Color', 'bosa-accounting' ),
		'description'  => esc_html__( 'It can be used as a transparent background color over image.', 'bosa-accounting' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Non Transparent Mid Header Text Link Hover Color', 'bosa-accounting' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Mid Header Section Border', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Height (in px)', 'bosa-accounting' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Contact Details', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Phone Number', 'bosa-accounting' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Header Secondary Menu', 'bosa-accounting' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Footer Layouts', 'bosa-accounting' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Bottom Footer Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Select Image', 'bosa-accounting' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Link', 'bosa-accounting' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Target', 'bosa-accounting' ),
		'description' => esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-accounting' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Width', 'bosa-accounting' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Border', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_options', array(
	    'title'          => esc_html__( 'Featured Posts / Pages', 'bosa-accounting' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts / Pages', 'bosa-accounting' ),
		...
		'priority'    => '9',
		'choices'  => array(
			'featured_posts' => esc_html__( 'Featured Posts', 'bosa-accounting' ),
			'featured_pages' => esc_html__( 'Featured Pages', 'bosa-accounting' ),
		)
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Section', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Title', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title', 'bosa-accounting' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Description', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Description', 'bosa-accounting' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title and Description Alignment', 'bosa-accounting' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Layout', 'bosa-accounting' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-accounting' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Color', 'bosa-accounting' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Background Color', 'bosa-accounting' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Color', 'bosa-accounting' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Text Color', 'bosa-accounting' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Icon Color', 'bosa-accounting' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Hover Color', 'bosa-accounting' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Columns', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_columns',
		'section'     => 'feature_posts_options',
		'default'     => 'three_columns',
		'placeholder' => esc_attr__( 'Select category', 'bosa-accounting' ),
		'choices'  => array(
			'one_column'    => esc_html__( '1 Column', 'bosa-accounting' ),
			'two_columns'   => esc_html__( '2 Columns', 'bosa-accounting' ),
			'three_columns' => esc_html__( '3 Columns', 'bosa-accounting' ),
			'four_columns'  => esc_html__( '4 Columns', 'bosa-accounting' ),
		),
		'priority'	  =>  160,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Category', 'bosa-accounting' ),
		'description' => esc_html__( 'Recent posts will show if any category is not chosen.', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_category',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select category', 'bosa-accounting' ), 
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts Overlay Opacity', 'bosa-accounting' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post View Number', 'bosa-accounting' ),
		'description'  => esc_html__( 'Number of posts to show.', 'bosa-accounting' ),
		'type'         => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Height (in px)', 'bosa-accounting' ),
		'description'  => esc_html__( 'This option will only apply to Desktop. Please click on below Desktop Icon to see changes. Automatically adjust by theme default in the responsive devices.
		', 'bosa-accounting' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'render_feature_post_image_size',
		'section'     => 'feature_posts_options',
		'default'     => 'bosa-420-300',
		'placeholder' => esc_html__( 'Select Image Size', 'bosa-accounting' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Background Image Size', 'bosa-accounting' ),
		'type'         => 'radio',
		'settings'     => 'feature_posts_image_size',
		'section'      => 'feature_posts_options',
		'default'      => 'cover',
		'choices'      => array(
			'cover'    => esc_html__( 'Cover', 'bosa-accounting' ),
			'pattern'  => esc_html__( 'Pattern / Repeat', 'bosa-accounting' ),
			'norepeat' => esc_html__( 'No Repeat', 'bosa-accounting' ),
		),
		'priority'	   =>  220,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Border Radius (px)', 'bosa-accounting' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Text Alignment', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_text_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'text-left',
		'choices'     => array(
			'text-left'	 	=> esc_html__( 'Left', 'bosa-accounting' ),
			'text-center'  	=> esc_html__( 'Center', 'bosa-accounting' ),   
			'text-right'	=> esc_html__( 'Right', 'bosa-accounting' ),
		),
		'priority'	  =>  240,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Alignment', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_title_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'align-bottom',
		'choices'     => array(
			'align-top'	 	=> esc_html__( 'Top', 'bosa-accounting' ),
			'align-center'  => esc_html__( 'Center', 'bosa-accounting' ),   
			'align-bottom'  => esc_html__( 'Bottom', 'bosa-accounting' ),
		),
		'priority'	  =>  250,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title', 'bosa-accounting' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title Divider', 'bosa-accounting' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Posts category', 'bosa-accounting' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Date', 'bosa-accounting' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Author', 'bosa-accounting' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Comment', 'bosa-accounting' ),
		'type'        => 'checkbox',
	...
	// featured pages
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Pages Section', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 1', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_one',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 1', 'bosa-accounting' ),
		'choices'     => bosa_accounting_get_pages(),
		'priority'	  => 450,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 2', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_two',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 2', 'bosa-accounting' ),
		'choices'     => bosa_accounting_get_pages(),
		'priority'	  => 460,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 3', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_three',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_accounting_get_pages(),
		'placeholder' => esc_html__( 'Select Page 3', 'bosa-accounting' ),
		'priority'	  => 470,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 4', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_four',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_accounting_get_pages(),
		'placeholder' => esc_html__( 'Select Page 4', 'bosa-accounting' ),
		'priority'	  => 480,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Page Overlay Opacity', 'bosa-accounting' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Border Radius (px)', 'bosa-accounting' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Page Title', 'bosa-accounting' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Color', 'bosa-accounting' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Hover Color', 'bosa-accounting' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Horizontal Alignment', 'bosa-accounting' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Vertical Alignment', 'bosa-accounting' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts / Pages', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_advert_banner_options', array(
	    'title'          => esc_html__( 'Blog Advertisement Banner', 'bosa-accounting' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => '22',
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Banner', 'bosa-accounting' ),
		'description'  => esc_html__( 'Image dimensions 1230 by 100 pixels is recommended.', 'bosa-accounting' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Advertisement Banner Link', 'bosa-accounting' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    		=> esc_html__( 'Advertisement Banner Target', 'bosa-accounting' ),
		'description' 	=> esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-accounting' ),
		'type'     		=> 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Advertisement Banner', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_two_options', array(
	    'title'          => esc_html__( 'Featured Posts Two', 'bosa-accounting' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 24,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two Section', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Overlay Opacity', 'bosa-accounting' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Horizontal Alignment', 'bosa-accounting' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Vertical Alignment', 'bosa-accounting' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Layouts', 'bosa-accounting' ),
		'description' => esc_html__( 'Grid / List / Single/ Grid Thumbnail', 'bosa-accounting' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'blog_page_style_options',
	    'default'     => esc_html__( 'Thumbnail Post Options', 'bosa-accounting' ),
	    'priority'	  => 300,
	    'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-accounting' ),
		'description' => esc_html__( 'Image Size for thumbnail post only.', 'bosa-accounting' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Border Radius (px)', 'bosa-accounting' ),
		'description' => esc_html__( 'Post Border Radius for thumbnail post only.', 'bosa-accounting' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Date', 'bosa-accounting' ),
		'description'  => esc_html__( 'Disables date for thumbnail post only.', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Author', 'bosa-accounting' ),
		'description'  => esc_html__( 'Disables author for thumbnail post only.', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Comment Link', 'bosa-accounting' ),
		'description'  => esc_html__( 'Disables comment link for thumbnail post only.', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Excerpt', 'bosa-accounting' ),
		'description'  => esc_html__( 'Disables excerpt for thumbnail post only.', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Post Button', 'bosa-accounting' ),
		'description'  => esc_html__( 'Disables button for thumbnail post only.', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_services', array(
	    'title'          => esc_html__( 'Services', 'bosa-accounting' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 26,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services Section', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	//Team Members
	Kirki::add_section( 'blog_team_members', array(
	    'title'          => esc_html__( 'Team Members', 'bosa-accounting' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 27,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Team Section', 'bosa-accounting' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_team_members_section',
		'section'      => 'blog_team_members',
		'default'      => true,
		'priority'	   => 10,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 1', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'team_members_page_one',
		'section'     => 'blog_team_members',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 1', 'bosa-accounting' ),
		'choices'     => bosa_accounting_get_pages(),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 2', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'team_members_page_two',
		'section'     => 'blog_team_members',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 2', 'bosa-accounting' ),
		'choices'     => bosa_accounting_get_pages(),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 3', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'team_members_page_three',
		'section'     => 'blog_team_members',
		'default'     => '',
		'choices'     => bosa_accounting_get_pages(),
		'placeholder' => esc_html__( 'Select Page 3', 'bosa-accounting' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Team Members', 'bosa-accounting' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_mobile_team_members',
		'section'      => 'blog_page_responsive',
		'default'      => false,
		'priority'	   => 27,
		'active_callback' => array(
			array(
				'setting'  => 'disable_team_members_section',
				'operator' => '==',
				'value'    => false,
			),
		),
	...
	//Category
	Kirki::add_section( 'blog_category', array(
	    'title'          => esc_html__( 'Category', 'bosa-accounting' ),
	    'description'  	 => esc_html__( 'WooCommerce plugin is required for this section.', 'bosa-accounting' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 28,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Category Section', 'bosa-accounting' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_category_section',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Title ', 'bosa-accounting' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image One', 'bosa-accounting' ),
		'type'         => 'image',
		'settings'     => 'category_image_one',
		'section'      => 'blog_category',
		'default'      => '',
		'priority'	   => 30,
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image One Category', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'category_one',
		'section'     => 'blog_category',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category One', 'bosa-accounting' ),
		'choices'     => bosa_accounting_get_product_categories(),
		'priority'	  => 40,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Two', 'bosa-accounting' ),
		'type'         => 'image',
		'settings'     => 'category_image_two',
		'section'      => 'blog_category',
		'default'      => '',
		'priority'	   => 50,
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Two Category', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'category_two',
		'section'     => 'blog_category',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Two', 'bosa-accounting' ),
		'choices'     => bosa_accounting_get_product_categories(),
		'priority'	  => 60,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Three', 'bosa-accounting' ),
		'type'         => 'image',
		'settings'     => 'category_image_three',
		'section'      => 'blog_category',
		'default'      => '',
		'priority'	   => 70,
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Three Category', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'category_three',
		'section'     => 'blog_category',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Three', 'bosa-accounting' ),
		'choices'     => bosa_accounting_get_product_categories(),
		'priority'	  => 80,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Four', 'bosa-accounting' ),
		'type'         => 'image',
		'settings'     => 'category_image_four',
		'section'      => 'blog_category',
		'default'      => '',
		'priority'	   => 90,
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Four Category', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'category_four',
		'section'     => 'blog_category',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Four', 'bosa-accounting' ),
		'choices'     => bosa_accounting_get_product_categories(),
		'priority'	  => 100,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Category', 'bosa-accounting' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_mobile_category',
		'section'      => 'blog_page_responsive',
		'default'      => false,
		'priority'	   => 28,
		'active_callback' => array(
			array(
				'setting'  => 'disable_category_section',
				'operator' => '==',
				'value'    => false,
			),
		),
	...
	Kirki::add_section( 'blog_popular_brands', array(
	    'title'          => esc_html__( 'Popular Brands', 'bosa-accounting' ),
	    'description'  	 => esc_html__( 'WooCommerce plugin is required for this section.', 'bosa-accounting' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 29,
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Popular Brands Section', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Sub Title', 'bosa-accounting' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Five', 'bosa-accounting' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Five Category', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'brand_category_five',
		'section'     => 'blog_popular_brands',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Five', 'bosa-accounting' ),
		'choices'     => bosa_accounting_get_product_categories(),
		'priority'	  => 130,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Six', 'bosa-accounting' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Image Six Category', 'bosa-accounting' ),
		'type'        => 'select',
		'settings'    => 'brand_category_six',
		'section'     => 'blog_popular_brands',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Six', 'bosa-accounting' ),
		'choices'     => bosa_accounting_get_product_categories(),
		'priority'	  => 150,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Popular Brands', 'bosa-accounting' ),
		'type'         => 'checkbox',
	...
	// Typography
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Title Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Price Typography', 'bosa-accounting' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Add to Cart Button Typography', 'bosa-accounting' ),
		'type'         => 'typography',
