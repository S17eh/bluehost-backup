...
function bosa_accounting_default_styles(){
	...
	if( get_theme_mod( 'disable_mobile_team_members', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
				.section-teams-area {
	    			display: none;
	...
	# Responsive Category
	if( get_theme_mod( 'disable_mobile_category', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
	...
	# Responsive Popular Brand
	if( get_theme_mod( 'disable_mobile_popular_brands', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
...
add_action( 'wp_head', 'bosa_accounting_default_styles', 99 );