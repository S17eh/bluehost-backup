...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_accounting_blog_advertisement_banner(); ?>
			...
			<?php if ( class_exists( 'woocommerce' ) ) { ?>
				...
				<!--Blog Popular Brands-->
			 	<?php get_template_part( 'template-parts/popular-brands/popular-brands' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-accounting' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-accounting' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-accounting' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-accounting' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-accounting' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
