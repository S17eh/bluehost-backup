...
import FunctionalAreaList from './FunctionalAreaList';
        ...
        <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={12} md={4}>
                <Card variant="outlined">
                    <CardHeader title="Add Functional Area" />
                    <CardContent>
                        {checkRestriction('CAN_ADD_FUNCTIONAL_AREA') ? (
                            <AddEditFunctionalArea formID="addFunctionalArea" onSubmit={submitHandler} />
                        ) : (
                            <Typography
                                sx={{
                                    p: '8%'
            ...
            <Grid item xs={12} sm={12} md={8}>
                <MainCard
                            ...
                            <Grid item xs={12}>
                                <Grid container spacing={gridSpacing}>
                                    <Grid item sx={{ flexGrow: 1 }}>
                                        <Typography variant="column">Functional Area List</Typography>
                                    </Grid>
                                    <Grid item>
                                        <OutlinedInput
                    ...
                    content={true}
                >
                    <FunctionalAreaList search={search} callApi={callApi} />
                </MainCard>
            </Grid>
        </Grid>
    );
