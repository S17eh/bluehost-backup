...
import { addUpdateFunctionalAreaApi } from 'apis/Setting';
...
const AddEditFunctionalArea = ({ value, formID, onSubmit }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            addUpdateFunctionalAreaApi(values)
                .then((res) => {
...
AddEditFunctionalArea.propTypes = {
    value: propTypes.object,
    formID: propTypes.string,
    onSubmit: propTypes.func
};

export default AddEditFunctionalArea;
