        ...
        <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={12} md={4}>
                <Card variant="outlined">
                    <CardHeader title="Add Job Title" />
                    <CardContent>
                        {checkRestriction('CAN_ADD_JOB_TITLE') ? (
                            <AddEditJobTitle formID="addJobTitle" onSubmit={submitHandler} />
                        ) : (
                            <Typography
                                sx={{
                                    p: '8%'
            ...
            <Grid item xs={12} sm={12} md={8}>
                <MainCard
                            ...
                            <Grid item xs={12}>
                                <Grid container spacing={gridSpacing}>
                                    <Grid item sx={{ flexGrow: 1 }}>
                                        <Typography variant="column">Job Title List</Typography>
                                    </Grid>
                                    <Grid item>
                                        <OutlinedInput
                    ...
                    content={true}
                >
                    <JobTitleList search={search} callApi={callApi} />
                </MainCard>
            </Grid>
        </Grid>
    );
