...
import { addUpdateJobTitleApi } from 'apis/Setting';
...
const AddEditJobTitle = ({ value, formID, onSubmit }) => {
...
AddEditJobTitle.propTypes = {
    value: propTypes.object,
    formID: propTypes.string,
    onSubmit: propTypes.func
};

export default AddEditJobTitle;
