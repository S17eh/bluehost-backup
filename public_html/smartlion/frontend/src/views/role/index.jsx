    ...
    return (
        <>
            <MainCard
                ...
                content={true}
            >
                <RoleList search={search} callApi={callApi} setInitList={setInitList} initList={initList} />
            </MainCard>

            {openAdd && (
                <CommonDialog open={openAdd} title="Add Role" onClose={() => setOpenAdd((prevState) => !prevState)} id="addRole">
                    <AddEditRole formId="addRole" onSubmit={submitHandler} initList={initList} />
                </CommonDialog>
            )}
        </>
    );
