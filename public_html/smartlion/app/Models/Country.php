...
class Country extends Model
{
    ...
    protected $allowedFields    = ['name', 'sortname', 'phonecode', 'status', 'created_at', 'updated_at'];
    ...
    public function getResource($filters = [], $returnAssoc = false, $returnSingleRow = false)
    {
        ...
        $builder->select('id,name,sortname,phonecode,status');
    ...
    /**
     * This function get status vise country
     * @param string $status
     * @return array
     */
    public function countryByStatus($status = 'Active')
    {
        $builder = $this->builder();
